...
export const metadata: Metadata = {
  ...
  description:
    "Contact Five7 for retail inquiries, store visits, or export partnerships. We are a premium men's fashion brand expanding reach across Kerala and UAE.",
};
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                label: "Phone",
                value: "+971 58 554 7757",
                link: "tel:+971585547757",
                icon: (
              ...
              {
                label: "Email",
                value: "fivesevenuae@gmail.com",
                link: "mailto:fivesevenuae@gmail.com",
                icon: (
                  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
